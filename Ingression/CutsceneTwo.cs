...
public class CutsceneTwo : GameState
{
    private Entity bob;
    public override void Initialize()
    {
        ...
        talk.AddComponent(new ConversationManager("Content/Dialogue/Scene2.txt"));
        AddEntity(talk);
        ...
        talk.GetComponent<ConversationManager>().dialogueManager.Finished += () =>
        {
            ...
            GameStateManager.SwapScreen(new LevelScene("5", true));
        };                
